...
it('biedt user_id niet langer als formulierveld aan', function (string $page) {
    Livewire::test($page)->assertFormFieldDoesNotExist('user_id');
})->with([
    'sessie' => CreateSession::class,
    'wapen' => CreateWeapon::class,
    'locatie' => CreateLocation::class,
    'munitietype' => CreateAmmoType::class,
]);
