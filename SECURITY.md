...
1. Meld kwetsbaarheden via **security@aimtrack.nl**. Beschrijf impact, scope, reproduceerbare stappen en (indien mogelijk) logs of request samples.
...
## Respons
- Binnen **2 werkdagen** ontvang je een ontvangstbevestiging vanaf `security@aimtrack.nl`.
