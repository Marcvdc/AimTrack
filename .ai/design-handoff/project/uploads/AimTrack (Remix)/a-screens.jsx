        ...
        <div style={{ padding: 24, display: 'grid', gridTemplateColumns: '1fr 340px', gap: 16, flex: 1, overflow: 'hidden', minHeight: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, minWidth: 0 }}>
            ...
            <div style={{ ...a.panel, padding: 20, display: 'flex', alignItems: 'flex-start', gap: 24, position: 'relative', overflow: 'hidden' }}>
              ...
              <div style={{ position: 'absolute', top: -60, right: -40, opacity: 0.07, pointerEvents: 'none' }}>
                <window.Reticle size={220} color={c.accent} stroke={1} dot />
              </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, minWidth: 0 }}>
            ...
            <div style={{ ...a.card, padding: 16, display: 'flex', flexDirection: 'column', gap: 12, position: 'relative' }}>
              {/* T3 · crosshair brackets */}
              <div style={{ position: 'absolute', top: -1, left: -1, width: 14, height: 14, borderTop: `1.5px solid ${c.accent}`, borderLeft: `1.5px solid ${c.accent}`, pointerEvents: 'none' }} />
              <div style={{ position: 'absolute', top: -1, right: -1, width: 14, height: 14, borderTop: `1.5px solid ${c.accent}`, borderRight: `1.5px solid ${c.accent}`, pointerEvents: 'none' }} />
              <div style={{ position: 'absolute', bottom: -1, left: -1, width: 14, height: 14, borderBottom: `1.5px solid ${c.accent}`, borderLeft: `1.5px solid ${c.accent}`, pointerEvents: 'none' }} />
              <div style={{ position: 'absolute', bottom: -1, right: -1, width: 14, height: 14, borderBottom: `1.5px solid ${c.accent}`, borderRight: `1.5px solid ${c.accent}`, pointerEvents: 'none' }} />
