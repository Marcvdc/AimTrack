    ...
    <div style={styles.root}>
      ...
      <div style={styles.body}>
        ...
        <div style={{ ...styles.panel, ...styles.panelDivR }}>
          ...
          <div style={{ flex: 1, padding: 14, border: `1px solid ${c.accent}40`, borderRadius: 4, background: `${c.accent}08`, display: 'flex', flexDirection: 'column', gap: 10, position: 'relative' }}>
            <div style={{ position: 'absolute', top: -1, left: -1, width: 16, height: 16, borderTop: `1.5px solid ${c.accent}`, borderLeft: `1.5px solid ${c.accent}` }} />
            <div style={{ position: 'absolute', top: -1, right: -1, width: 16, height: 16, borderTop: `1.5px solid ${c.accent}`, borderRight: `1.5px solid ${c.accent}` }} />
            <div style={{ position: 'absolute', bottom: -1, left: -1, width: 16, height: 16, borderBottom: `1.5px solid ${c.accent}`, borderLeft: `1.5px solid ${c.accent}` }} />
            <div style={{ position: 'absolute', bottom: -1, right: -1, width: 16, height: 16, borderBottom: `1.5px solid ${c.accent}`, borderRight: `1.5px solid ${c.accent}` }} />
