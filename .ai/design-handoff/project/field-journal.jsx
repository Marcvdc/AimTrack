    ...
    <div style={styles.root}>
      ...
      <div style={styles.main}>
        <div style={styles.content}>
          ...
          {groupedSessions.map((g, gi) => (
            <div key={gi} style={{ marginBottom: 6 }}>
              <div style={{ ...styles.monthRow, display: 'flex', alignItems: 'center', gap: 14 }}>
                <window.ATMark size={18} color={c.accent} />
                <span>{g.month}</span>
                <div style={styles.monthLine} />
                <span>{g.items.length} sessies</span>
                <div style={styles.monthLine} />
                <window.ATMark size={18} color={c.muted} />
              </div>
              {g.items.map((s) => (
        ...
        <aside style={styles.aside}>
          ...
          <window.BracketFrame palette={c} bordered panel={false} rounded={14} padding={18} style={{ background: c.bg, display: 'flex', flexDirection: 'column', gap: 12 }}>
