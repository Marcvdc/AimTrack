    ...
    <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginTop: 44 }}>
          {[
            ...
            },
            {
              ...
              demo: (
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 12px', background: c.bg, border: `1px solid ${c.line}`, borderRadius: 8, position: 'relative' }}>
                  <window.MonogramStamp palette={c} fonts={fonts} label="EXPORT OK" corner="top-right" />
      ...
      <section style={{ padding: '96px 64px', borderTop: `1px solid ${c.line}`, position: 'relative' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.1fr', gap: 64, alignItems: 'center' }}>
          ...
          {/* Mock chat */}
          <window.BracketFrame palette={c} bordered panel rounded={16} padding={24} style={{ display: 'flex', flexDirection: 'column', gap: 14, overflow: 'hidden' }} cornerSize={18}>
